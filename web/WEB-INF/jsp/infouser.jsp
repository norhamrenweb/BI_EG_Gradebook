...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<c:url value="/recursos/css/msdropdown/dd.css" />" />
...
<!--    PRUEBA SELECT CON IMAGENES-->
    <script type="text/javascript" src="<c:url value="/recursos/js/msdropdown/jquery.dd.js" />"></script>
<!--    PRUEBA SELECT CON IMAGENES-->
    ...
    <script type="text/javascript" src="<c:url value="/recursos/js/bootstrap-select.js"/>"></script>
